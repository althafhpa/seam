...
export declare const ENCODER_DEVICE_TYPE_LIST: "visionline_encoder"[];
export declare const encoder_device_type: z.ZodEnum<["visionline_encoder"]>;
export type EncoderDeviceType = z.infer<typeof encoder_device_type>;
export declare const any_device_type: z.ZodUnion<[z.ZodEnum<[LockDeviceTypeFromMapping]>, z.ZodEnum<[NoiseSensorDeviceTypeFromMapping]>, z.ZodEnum<[ThermostatDeviceTypeFromMapping]>, z.ZodEnum<[PhoneDeviceTypeFromMapping]>, z.ZodEnum<["visionline_encoder"]>]>;
