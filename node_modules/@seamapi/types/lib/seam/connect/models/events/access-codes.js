...
export const access_code_delay_in_setting_on_device_event = access_code_event
    ...
    .describe('There was an unusually long delay in setting an access code on a device.');
...
export const access_code_delay_in_removing_from_device_event = access_code_event
    ...
    .describe('There was an unusually long delay in removing an access code from a device.');
...
export const access_code_backup_access_code_pulled_event = access_code_event
    ...
    .describe('A backup access code was pulled from the backup access code pool and set on a device.');
export const unmanaged_access_code_converted_to_managed_event = access_code_event
    .extend({
    event_type: z.literal('access_code.unmanaged.converted_to_managed'),
})
    .describe('An unmanaged access code was successfully converted to a managed access code.');
export const unmanaged_access_code_failed_to_convert_to_managed_event = access_code_event
    .extend({
    event_type: z.literal('access_code.unmanaged.failed_to_convert_to_managed'),
})
    .describe('An unmanaged access code failed to be converted to a managed access code.');
